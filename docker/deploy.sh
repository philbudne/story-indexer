...
PIPEVIEW_READONLY_USER=chance
PIPEVIEW_READONLY_PASSWORD=iliketowatch
...
sed -e "s/__RO_USER__/$PIPEVIEW_READONLY_USER/g" \
    -e "s/__RO_USER_PW__/$PIPEVIEW_READONLY_PASSWORD/" \
    < ../conf/pipeview-db/init-ro-user.sql.in > ../conf/pipeview-db/init-ro-user.sql
...
add PIPEVIEW_READONLY_PASSWORD
add PIPEVIEW_READONLY_USER
add QUEUER_ARGS
